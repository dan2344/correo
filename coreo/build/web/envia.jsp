...
<%
    ...
    String respuesta="";
     ...
     String urlRegistroValido = "?validador="+"1";
      ...
      String contenido = "<h1>¡Estás a un paso de formar parte de nuestra comunidad!</h1>";
       contenido+="Para validar tu registro da clic <a href=\"http://localhost:8080/coreo/recibe.jsp" + urlRegistroValido+"\">aqui</a> para confirmar ";
    ...
    if(enviar.mandaMAil("america_emerson7@hotmail.com", "Hola Dan", contenido)){
        respuesta="enviado";
    }else{
